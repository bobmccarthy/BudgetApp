	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement('input', { ref: 'date', type: 'date' }),
				React.createElement(
					'h2',
					null,
					'For What?'
				...
				React.createElement('input', { ref: 'amount', type: 'number' }),
				React.createElement(
					'button',
					null,
					'Enter'
...
},{"../models/FinancesModel":161,"react":158}],160:[function(require,module,exports){
...
ReactDOM.render(React.createElement(BudgetComponent, null), document.getElementById('main'));

},{"./components/BudgetComponent":159,"react":158,"react-dom":2}],161:[function(require,module,exports){
'use strict';
